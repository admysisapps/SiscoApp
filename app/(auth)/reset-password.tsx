            ...
            <View>
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={
                    fieldErrors.code ? COLORS.error : COLORS.text.secondary
                  }
              ...
              {fieldErrors.code && (
                <Text style={styles.errorText}>{fieldErrors.code}</Text>
              )}
            </View>
            ...
            <View>
              <View
                style={[
                  ...
                  code.length !== 6 && styles.inputContainerDisabled,
                ]}
              >
                <Ionicons
                ...
                <TextInput
                  style={[
                    styles.input,
                    code.length !== 6 && styles.inputDisabled,
                  ]}
