...
const AsambleaActivaApoderadoScreen: React.FC = () => {
  ...
  const [preguntaActiva, setPreguntaActiva] = useState<any>(null);
      ...
      >
        ...
        <View style={styles.actionsCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              router.push({
                pathname: "/(apoderado)/asamblea-activa/listaPreguntas",
                params: { asambleaId: asambleaId?.toString() },
              })
            }
          >
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                ...
                onPress={async () => {
                  ...
                  try {
                    if (asambleaId) {
                      await asistenciaService.salirAsamblea(asambleaId);
                    }

                    setCanExit(true);
                    router.replace(`/(apoderado)/asamblea/${asambleaId}`);
                  } catch (error) {
...
export default AsambleaActivaApoderadoScreen;
